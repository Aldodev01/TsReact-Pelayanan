const Footer = () => {
  return (
    <footer className=" fixed bottom-0 z-999 flex w-full max-w-[700px] bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 shadow-2 md:px-6 2xl:px-11">
        <div className=" w-full flex flex-col py-[10px] lg:flex-row lg:gap-4 items-center justify-center">
